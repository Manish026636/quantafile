...
const Hero = () => {
  return (
    <div>
      <div className=" mt-20 lg:mt-40 0 pb-6 sm:pb-8 lg:pb-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <section className="flex flex-col items-center">
            <div className="flex max-w-3xl flex-col items-center pb-0 pt-8 text-center sm:pb-16 lg:pb-32 lg:pt-32">
