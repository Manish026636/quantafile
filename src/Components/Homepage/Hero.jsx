    ...
    <div className="h-screen flex flex-col justify-center">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <section className="flex flex-col items-center">
          ...
          <h1 className="mb-8 text-4xl heroheading font-extrabold text-black sm:text-5xl md:mb-12 md:text-8xl transition-color duration-300 ">Experience the Future of College Automation</h1>
